                ...
                <div className="w-full h-auto 2xl:p-[110px_75px] xl:p-[70px_50px] md:p-[40px_30px] sm:p-[30px_20px] p-[20px_15px] bg-[#07163D] rounded-[10px] overflow-hidden flex flex-wrap relative z-0 group">
                    ...
                    <div className="w-full h-auto block">
                        ...
                        <Link
                            ...
                            className="2xl:text-[16px] md:text-[12px] text-[11px] leading-normal font-medium text-white min-w-[70px] w-fit 2xl:h-[40px] md:h-[30px] 2xl:p-[10px_20px] sm:p-[7px_15px] p-[8px_10px] 2xl:mt-[25px] mt-[15px] rounded-[5px] bg-[#BE1E2D] flex items-center justify-center hover:bg-base1 transition-colors duration-300 ease-in-out"
                            color="black"
                        >
                            GET IN TOUCH
                        </Link>

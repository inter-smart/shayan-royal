                ...
                <div className="relative w-full h-full flex flex-col items-center justify-center gap-3">
                    ...
                    >
                        <div className="lg:max-w-[13px] max-w-[10px] flex">
                            ...
                            <Image src="/images/callIcon.svg" width="13" height="13" className="object-contain" />
                        </div>
                    </a>
                    ...
                    >
                        <div className="lg:max-w-[13px] max-w-[10px] flex">
                            {/* <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                              ...
                              <Image src="/images/mailIcon.svg" width="13" height="13" className="object-contain" />
                    ...
                    >
                        <div className="lg:max-w-[13px] max-w-[10px] flex">
                            {/* <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <Image src="/images/wtapicon.svg" width="13" height="13" className="object-contain" />
                        </div>
                    </a>
                </div>
            </div>

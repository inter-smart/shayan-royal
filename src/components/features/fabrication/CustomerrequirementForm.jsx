...
// Tailwind Classes
const menuLinkClass =
    "!text-[11px] md:!text-[12px] 2xl:!text-[14px] 3xl:!text-[17px] !text-black placeholder:text-black !font-normal max-w-full min-h-[35px] lg:min-h-[40px] 2xl:min-h-[50px] !w-full px-0 border-0 border-b border-[#000] bg-transparent rounded-[0px] font-medium outline-none shadow-none focus:outline-none focus:ring-0 focus:shadow-none data-[state=open]:shadow-none font-base1";
                ...
                <div className="relative bg-[#F5F9FF] px-[15px] md:px-[25px] 2xl:px-[35px] py-[30px] md:py-[40px] 2xl:py-[65px] 3xl:py-[95px] rounded-[10px] overflow-hidden">
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-wrap items-end">
                            ...
                            <FormField name="modelYear" control={form.control} render={({ field }) => (
                                <FormItem className="w-full md:w-1/3 2xs:w-1/2 lg:p-[15px] p-[8px] relative">
                                    <FormControl>
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            <SelectTrigger className={menuLinkClass}>
                                            ...
                                            <SelectContent className={contentClass}>
                                                ...
                                                <SelectItem value="2023" className={itemClass}>2023</SelectItem>
                                                <SelectItem value="2024" className={itemClass}>2024</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </FormControl>
                                    <FormMessage className={errorMessage} />
                                    ...
                                    <FormControl>
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            ...
                                            <SelectContent className={contentClass}>
                                                ...
                                                <SelectItem value="truck" className={itemClass}>Truck</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </FormControl>
                                    <FormMessage className={errorMessage} />
                                ...
                                <FormItem className="w-full md:w-1/2 lg:p-[15px] p-[8px] relative">
                                    <FormControl>
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            ...
                                            <SelectContent className={contentClass}>
                                                <SelectItem value="10k" className={itemClass}>Up to $10,000</SelectItem>
                                                <SelectItem value="20k" className={itemClass}>$10,000 - $20,000</SelectItem>
                                                <SelectItem value="30k" className={itemClass}>$20,000 - $30,000</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </FormControl>
                                    <FormMessage className={errorMessage} />
                                    ...
                                    <FormControl>
                                        <Popover>
                                            <PopoverTrigger asChild>
                                                <button
                                                    className={cn("text-left flex items-center justify-between cursor-pointer", menuLinkClass, !field.value && "text-muted-foreground")}
                                                >

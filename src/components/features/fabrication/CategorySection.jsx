      ...
      <div className="container">
        ...
        <div className="relative w-full">
          ...
          <div className="flex items-center justify-center absolute top-0 bottom-0 w-full mt-[-150px] 3xs:mt-[-90px] md:mt-0">
            <button className="btn-prevBtn absolute left-[-40px] sm:left-[-45px] -translate-y-1/2 z-10
              ...
              <svg className="w-[30px] h-[15px] 2xl:w-[45px] 2xl:h-[25px]" viewBox="0 0 16 31" fill="none">
                <path d="M2.76145e-07 15.4999C2.91897e-07 15.8603 0.130332 16.221 0.390664 16.4962L13.7239 30.587C14.2449 31.1377 15.0886 31.1377 15.6093 30.587C16.1299 30.0364 16.1302 29.1448 15.6093 28.5946L3.21865 15.4999L15.6093 2.40527C16.1302 1.85467 16.1302 0.963068 15.6093 0.412819C15.0883 -0.13743 14.2446 -0.137783 13.7239 0.412819L0.390664 14.5037C0.130332 14.7788 2.60392e-07 15.1396 2.76145e-07 15.4999Z" fill="black" fillOpacity="0.4" />
              </svg>

            </button>
            <button className="btn-nextBtn absolute right-[-40px] sm:right-[-45px] -translate-y-1/2 z-10 

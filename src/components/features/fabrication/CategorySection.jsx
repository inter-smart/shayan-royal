...
const categories = [
  {
    ...
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Esse enim quam vellet iniquus iustus poterat inpune.",
    features: [
      {
        title: "Armoring",
    ...
    images: ["/images/categories/cat1.jpg", "/images/categories/cat2.jpg", "/images/categories/cat3.jpg"],
  },
  {
    title: "Off-Road & Adventure Mods",
    description: "Off-road upgrades to tackle any terrain. Better suspension, airflow, and tires.",
    features: [
      {
    ...
    images: ["/images/categories/cat4.jpg", "/images/categories/cat5.jpg", "/images/categories/cat6.jpg"],
  },
  {
    title: "Utility & Commercial Mods",
    description: "Convert vehicles for commercial use with specialized storage and utility features.",
    features: [
    ...
    images: ["/images/categories/cat7.jpg", "/images/categories/cat8.jpg", "/images/categories/cat9.jpg"],
  },
  {
    title: "Special Purpose Conversions",
    description: "Vehicles modified for emergency services and high-security transport.",
    features: [
    ...
    images: ["/images/categories/cat10.jpg", "/images/categories/cat11.jpg", "/images/categories/cat12.jpg"],
  },
  {
    title: "Performance & Aesthetic Mods",
    description: "Enhance performance and appearance with premium customizations.",
    features: [
    ...
    <section className="relative 3xl:py-[120px_65px] 2xl:py-[80px_40px] xl:py-[40px] py-[30px] overflow-hidden">
      <div className="container">
        <div className="3xl:mb-[60px] 2xl:mb-[50px] xl:mb-[30px] mb-[20px] text-center">
          <Heading size="heading2" as="h2" className="text-black uppercase font-normal mb-[15px]">
            {title || "Category Section"}
          </Heading>
          <Text size="Text1" as="p" className="max-w-[730px] m-auto">
            {description || "The reasons to choose shayan royal lorem Ipsum has been the industry's standard dummy text ever since"}
          </Text>
        </div>
        ...
        <div className="relative w-full">
                ...
                <div className="flex flex-wrap">
                  ...
                  <div className="w-full md:w-1/2 flex items-center">
                    <div className="w-full [&>p]:text-[#4B4B4B]">
                      <div className="text-[18px] lg:text-[22px] xl:text-[25px] 2xl:text-[35px] 3xl:text-[40px] font-medium mb-[15px]">
                        {category.title}
                      </div>
                      ...
                      <ul className="my-[20px]">
                        {category.features.map((feature, idx) => (
                          <li
                            key={idx}
                            className="relative pl-[25px] before:absolute before:content-[''] before:top-[10px] 3xl:before:top-[15px]
                           before:left-0 before:w-[6px] before:h-[6px] 2xl:before:w-[8px] 2xl:before:h-[8px] 3xl:before:w-[10px] 
                           3xl:before:h-[10px] before:rounded-full before:bg-black [&>p]:text-[#4B4B4B] not-last-of-type:mb-[15px]"
                          >
                            <div className="text-[16px] 2xl:text-[21px] 3xl:text-[25px] font-semibold leading-normal font-base1">
          ...
          <div className="flex items-center justify-center absolute top-0 bottom-0 w-full mt-[-150px] 3xs:mt-[-90px] md:mt-0">
            <button
              className="btn-prevBtn absolute left-[-40px] sm:left-[-45px] -translate-y-1/2 z-10
                ...
                disabled:opacity-[1]"
            >
              <svg className="w-[30px] h-[15px] 2xl:w-[45px] 2xl:h-[25px]" viewBox="0 0 16 31" fill="none">
                <path
                  d="M2.76145e-07 15.4999C2.91897e-07 15.8603 0.130332 16.221 0.390664 16.4962L13.7239 30.587C14.2449 31.1377 15.0886 31.1377 15.6093 30.587C16.1299 30.0364 16.1302 29.1448 15.6093 28.5946L3.21865 15.4999L15.6093 2.40527C16.1302 1.85467 16.1302 0.963068 15.6093 0.412819C15.0883 -0.13743 14.2446 -0.137783 13.7239 0.412819L0.390664 14.5037C0.130332 14.7788 2.60392e-07 15.1396 2.76145e-07 15.4999Z"
                  fill="black"
                  fill-opacity="0.4"
                />
              </svg>
            ...
            <button
              className="btn-nextBtn absolute right-[-40px] sm:right-[-45px] -translate-y-1/2 z-10 
            ...
            >
              <svg className="w-[30px] h-[15px] 2xl:w-[45px] 2xl:h-[25px]" viewBox="0 0 16 31" fill="none">
                <path
                  d="M16 15.4999C16 15.8603 15.8697 16.221 15.6093 16.4962L2.27607 30.587C1.75507 31.1377 0.911412 31.1377 0.390748 30.587C-0.129916 30.0364 -0.130249 29.1448 0.390748 28.5946L12.7813 15.4999L0.390749 2.40527C-0.130248 1.85467 -0.130248 0.963068 0.390749 0.412819C0.911747 -0.13743 1.75541 -0.137783 2.27607 0.412819L15.6093 14.5037C15.8697 14.7788 16 15.1396 16 15.4999Z"
                  fill="black"
                  fill-opacity="0.4"
                />
              </svg>

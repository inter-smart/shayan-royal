  ...
  return (
    <section className="relative bg-[#07163D] py-[40px] z-0 3xl:min-h-[850px] 2xl:min-h-[650px] xl:min-h-[550px] min-h-[450px] xl:py-[60px] 2xl:py-[80px] 3xl:py-[100px_160px] after:absolute after:top-0 after:right-0 after:content-[''] after:z-[1] after:w-1/2 after:h-full after:bg-[linear-gradient(271deg,rgba(7,22,61,0)_0.62%,#07163D_97.76%)]">
      <Image
        ...
        alt={alt ? alt : "Why Choose Us Section Image"}
      />
      <div className="container relative z-10">
        <div className="flex flex-wrap -m-4">
          <div className="w-full lg:w-1/2 p-4">
            <div className="3xl:mb-[70px] 2xl:mb-[50px] xl:mb-[30px] mb-[20px]">
              <Heading size="heading2" as="h2" className="text-white uppercase font-normal 3xl:mb-[40px] 2xl:mb-[25px] mb-[15px]">
                {title ? title : "Why Choose Us?"}
              </Heading>
              <Text size="text2" as="p" className="text-white">
                {description
                  ? description
                  : "We are committed to providing the best fabrication services with a focus on quality, reliability, and customer satisfaction. Our team of experts is dedicated to meeting your specific needs and exceeding your expectations."}
              </Text>
            </div>
                ...
                <div key={index} className="w-full 2xs:w-1/2 md:p-[15px] p-[5px]">
                  <div className={`w-full h-full bg-white 3xl:p-[30px] 2xl:p-[20px ] p-[15px] rounded-[10px]  ${index % 2 !== 0 ? "ml-auto" : ""}`}>
                    <div className="flex flex-wrap justify-between items-center 3xl:mb-[20px] 2xl:mb-[15px] mb-[10px]">
                      <Heading size="heading5" as="h3" className="text-black font-semibold line-clamp-2">
                        {item?.title || "Original Products"}
                      </Heading>
                      <div className="3xl:w-[95px] 2xl:w-[70px] w-[40px] 3xl:h-[55px] 2xl:h-[40px] h-[35px] flex items-center justify-center ">
                        <Image src={item.icon ? `${mediaUrl}${item.icon}` : "/images/whychoose_icon1.svg"} width={65} height={55} alt={item.title} />
                      </div>
                    </div>

...
export default function CarSearchForm() {
    ...
    const contentClass =
        "3xl:text-[18px] 2xl:text-[16px] md:text-[12px] sm:text-[10px] text-[8px] bg-white border border-[#CCCCCC] rounded-md shadow-md font-normal  uppercase placeholder:!text-black";

...
const servicesData = [
    {
        ...
        description:"International and local land transport logistics solutions.* Flexible and tailor made road services. Container transportation, Land transportation, LTL and FTL.*"
    },
    {
    ...
    },
    {
        ...
        description:"Marine insurance covers the loss or damage of ships, cargo, terminals, and any transport by which the property is transferred, acquired, or held between."
    },
    {
        title: "Ocean Freight Service",
        image: "/images/log4.jpg",
        description:"We provide reliable ocean freight transportation services tailored to your specific shipping & budget needs.The way to a customer’s heart is much more.."
    },
];
                    ...
                    <div className="w-full lg:w-1/2">
                        <div className="max-w-[85%]  mb-[15px] 2xl:mb-[30px] 3xl:mb-[50px]  ">
                            ...
                            <Text size="text1" as="p" className="text-black mb-[15px]">
                                ...
                                Polycratem Samium felicem apparet. Maximas vero virtutes iacere
                                omnis necesse est voluptate dominante. Lorem Ipsum has been the
                                industry's standard.
                            </Text>
                        </div>
                        <div className="3xl:max-w-[800px] 2xl:max-w-[650px] xl:max-w-[550px] max-w-[400px] w-full">
                            <Image
                        ...
                        <div className="flex flex-wrap w-full h-full">
                            {servicesData.map((item, index) => (
                                <div key={index} className="w-full 2xs:w-1/2 p-[8px] 2xl:p-[15px]">
                                    <div className="w-full h-full relative rounded-[10px] overflow-hidden group after:absolute after:left-0 after:bottom-0
                                     after:bg-[linear-gradient(180deg,_rgba(0,0,0,0)_0%,_#000_100%)] after:w-full after:h-full">
                                        <Image
                                            src={item.image}
                                            alt={item.title}
                                            fill
                                        ...
                                        <div className="w-full h-full absolute bottom-0 left-0 z-1 flex flex-col justify-end 3xl:p-[25px] p-[15px]">
                                            ...
                                            <div className="sm:opacity-0 sm:invisible sm:h-0 transition-all duration-500 ease-in-out group-hover:h-[130px] group-hover:opacity-100 group-hover:visible ">

...
export default function WhySection() {
  return (
    <section className="relative z-0 bg-[#F5F9FF] py-[30px_20px] xl:py-[35px_20px] 2xl:py-[50px_30px] 3xl:py-[70px_50px] after:absolute after:content-[''] overflow-hidden
      ...
      <div className="container">
        ...
        <div className="flex flex-wrap relative">
            ...
            <div key={index} className={`w-full 2xs:w-1/2 md:p-[32px] sm:p-[25px] p-[8px] `}>
              <motion.div
                ...
                className={`w-full h-full bg-white 3xl:p-[30px] 2xl:p-[20px] p-[15px] rounded-[10px] 
                  3xl:max-w-[460px] 2xl:max-w-[400px] lg:max-w-[285px] md:max-w-[275px] 2xs:max-w-[250px] ${
                    index % 2 !== 0 ? "ml-auto" : ""
                  }  `}
              >
          ...
          {/* Background Logo */}
          <div className="absolute top-[35%]  sm:top-0 sm:bottom-0 right-0 left-0 m-auto 3xl:max-w-[550px] 2xl:max-w-[400px] xl:max-w-[375px] lg:max-w-[275px] 

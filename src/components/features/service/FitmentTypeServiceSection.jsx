...
export default function FitmentTypeServiceSection() {
  ...
  // ✅ Group logic moved outside to prevent re-running on each render
  const groupedItems = [];
  for (let i = 0; i < items.length;) {
    if (i === 0 || i % 3 === 0) {
      ...
      groupedItems.push(items.slice(i, i + 1));
      i += 1;
    }
  }
  ...
  return (
    <section className="w-full h-auto block 3xl:py-[90px] 2xl:py-[70px] lg:py-[60px] sm:py-[50px] py-[40px] bg-[#F5F9FF] relative z-0">
      ...
      <div className="container">
        ...
        <div className="w-full h-[340px] md:h-[350px] xl:h-[475px] 2xl:h-[600px] 3xl:h-[930px] relative">
          <Swiper
                ...
                <div className="flex flex-col w-full h-full -my-[5px] 2xl:-my-[10px] 3xl:-my-[20px]">
                  {group.map((item, index) => (
                    <div
                      key={index}
                      className={`w-full ${
                        group.length === 1 ? "h-full" : "h-1/2"
                      } py-[5px] 2xl:py-[10px] 3xl:py-[20px]`}
                    >
                      <div className="w-full h-full rounded-[10px] overflow-hidden relative group">
                        ...
                        />
                        <div className="text-white font-semibold absolute right-[10px] 3xl:right-[20px] bottom-0 p-[10px] lg:p-[15px] 
          ...
          {/* Navigation Arrows */}
          <div className="absolute top-[45%] left-0 right-0 flex items-center justify-between w-full z-10 pointer-events-none">
            <button className="nav-prev pointer-events-auto bg-white rounded-full shadow 
            ...
            <button className="nav-next pointer-events-auto bg-white rounded-full shadow w-[30px] md:w-10 md:h-10 h-[30px]

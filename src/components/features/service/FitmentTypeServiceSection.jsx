                                ...
                                <SwiperSlide key={slideIndex}>
                                    <div className="flex flex-col w-full h-full -my-[5px] 2xl:-my-[10px] 3xl:-my-[20px]">
                                        {group.map((item, index) => (
                                            <div
                                                key={index}
                                                className={`w-full ${group.length === 1 ? "h-full" : "h-1/2"} py-[5px] 2xl:py-[10px] 3xl:py-[20px]`}
                                            >
                                                <div className="w-full h-full rounded-[10px] overflow-hidden relative group">
                                                    ...
                                                    <div className="text-white font-semibold absolute right-[10px] 3xl:right-[20px] bottom-0 p-[10px] lg:p-[15px] 
                                                        ...
                                                        <h2 className="text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] 2xl:text-[18px] 3xl:text-[25px] font-semibold">{item.title}</h2>
                                                    </div>
                                                </div>
                                            </div>
                                        ))}

...
export default function ChooseServicesSection({ chooseItems, image, title }) {
  ...
  return (
    <section className="w-full h-auto block overflow-hidden bg-[#F5F9FF] 3xl:py-[110px] 2xl:py-[80px] lg:py-[70px] sm:py-[50px] py-[40px] relative z-0">
      <div className="3xl:w-[1020px] 2xl:w-[810px] xl:w-[680px] md:w-[570px] sm:w-[480px] w-[280px] h-auto aspect-[1020/580] xl:mb-[0] mb-[20px] xl:absolute z-1 right-0 top-0 bottom-0 m-auto flex items-center">
        <motion.div
          ref={ref}
        ...
        <div className="xl:w-[52%] w-full 3xl:m-[-17px] lg:m-[-12px] sm:m-[-8px] m-[-5px] flex flex-wrap">
          {chooseItems?.map((item, index) => (
            <div key={index} className="w-full sm:w-[calc(100%/2)] 3xl:p-[17px] lg:p-[12px] sm:p-[8px] p-[5px]">
              ...
              <div className="w-full h-full 3xl:p-[20px_25px] sm:p-[15px_20px] p-[10px_15px] bg-white rounded-[10px] overflow-hidden flex items-center relative z-0 group">
                ...
                <div className="3xl:w-[95px] 2xl:w-[70px] lg:w-[60px] sm:w-[50px] w-[40px] h-auto aspect-[95/95] 3xl:p-[20px] 2xl:p-[15px] lg:p-[12px] sm:p-[10px] p-[7px] bg-[#E7F0FD] rounded-[50%] overflow-hidden flex items-center justify-center group-hover:bg-white transition-all duration-300">
                  <Image
                ...
                <div className="3xl:w-[calc(100%-95px)] 2xl:w-[calc(100%-70px)] lg:w-[calc(100%-60px)] sm:w-[calc(100%-50px)] w-[calc(100%-40px)] 3xl:pl-[30px] 2xl:pl-[20px] sm:pl-[15px] pl-[10px]">
                  <h4 className="3xl:text-[22px] 2xl:text-[16px] sm:text-[14px] text-[13px] leading-[1.2] font-medium font-base1 text-black group-hover:text-white transition-all duration-300">
                    {item.title}
                  </h4>
                </div>
              </div>

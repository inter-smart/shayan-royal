...
export default function ServiceSection({ services = items }) {
  const [hovered, setHovered] = useState(null);
  const [activeIndex, setActiveIndex] = useState(0);

  return (
    <section
      className="w-full h-auto block 3xl:py-[45px_135px] 2xl:py-[40px_100px] sm:py-[35px_60px] py-[30px_30px] 3xl:mb-[120px] 2xl:mb-[50px] lg:mb-[40px] 
        ...
        <div className="relative 2xl:p-[40px_15px] xl:p-[40px_10px] sm:p-[30px_7px] p-[20px_7px]">
          ...
          >
            {services?.map((item, index) => (
              ...
              >
                <div
                  className={`group w-full h-auto aspect-545/760 3xl:p-[0_45px_50px_45px] 2xl:p-[0_35px_40px_35px] lg:p-[0_30px_35px_30px] sm:p-[0_20px_20px_20px] p-[0_10px_20px_20px] overflow-hidden flex flex-col justify-end relative z-0 before:content-[''] before:absolute before:-z-1 before:bottom-0 before:left-0 before:w-full before:h-[60%] before:bg-gradient-to-b before:from-[rgb(0,0,0,0)] before:to-[rgb(0,0,0,1)] before:pointer-events-none before:transition-all before:duration-500 before:ease-in-out ${
                ...
                >
                  <div className="w-full h-full overflow-hidden block absolute -z-2 inset-0">
                    <Image
                      ...
                      className={`${
                        hovered === index || (hovered === null && activeIndex === index) ? "scale-105" : ""
                  ...
                  <div
                    className={`3xl:text-[32px] 2xl:text-[24px] lg:text-[20px] sm:text-[18px] text-[16px] leading-[1] font-semibold 
                                            font-base1 text-white mb-[15px] ${
                                              hovered === index || (hovered === null && activeIndex === index) ? "opacity-0" : ""
                  ...
                  <div
                    className={`absolute z-1 bottom-0 left-0 w-full h-auto 3xl:p-[0_45px_50px_45px] 2xl:p-[0_35px_40px_35px] lg:p-[0_30px_35px_30px] sm:p-[0_20px_20px_20px] p-[0_10px_20px_20px] ${
                      hovered === index || (hovered === null && activeIndex === index) ? "translate-y-0" : "xs:translate-y-[100%]"
                    } transition-all duration-500 ease-in-out`}
                  >
                    ...
                    <p className="3xl:text-[20px] 2xl:text-[16px] lg:text-[14px] sm:text-[13px] text-[12px]  font-normal font-base1 text-white 3xl:mb-[30px] lg:mb-[20px] sm:mb-[15px] mb-[10px]">

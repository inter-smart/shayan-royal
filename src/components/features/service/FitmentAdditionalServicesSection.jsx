...
export default function FitmentAdditionalServicesSection({ items, title }) {
  ...
  return (
    <section className="w-full h-auto block 3xl:py-[90px_120px] 2xl:py-[70px_90px] lg:py-[60px_80px] sm:py-[50px_60px] py-[40px_40px]">
      <div className="container">
        <Heading
          as="h2"
          className="text-center 3xl:text-[50px] 2xl:text-[40px] xl:text-[32px] lg:text-[28px] 2xs:text-[24px] text-[18px]
           text-[#262626] uppercase font-semibold font-base1 2xl:mb-[45px] mb-[30px] 3xl:max-w-[880px] 2xl:max-w-[650px] 
           xl:max-w-[550px] max-w-[450px] mx-auto leading-[1.2]"
        >
        ...
        <div className="relative">
          ...
          >
            {items?.map((item, index) => (
              <SwiperSlide key={index} className="flex !h-auto border-r last-of-type:border-0">
                <div
                  className={`w-full h-full text-center 3xl:pt-[55px] 2xl:pt-[35px] xl:pt-[25px] pt-[20px] 3xl:pr-[50px] 2xl:pr-[40px]
                     xl:pr-[30px] pr-[15px] 3xl:pb-[80px] 2xl:pb-[50px] xl:pb-[30px] pb-[20px] 3xl:pl-[50px] 2xl:pl-[40px] xl:pl-[30px] 
                     pl-[15px] flex flex-col items-center justify-start 3xl:min-h-[340px] 2xl:min-h-[265px] xl:min-h-[220px] min-h-[180px]
                      transition-all duration-800 ease-in-out bg-[#F5F9FF] group hover:bg-gradient-to-b hover:from-[#2E4C99] hover:to-[#0E1D44] `}
                >
                  ...
                  <div className="3xl:text-[26px] 2xl:text-[22px] xl:text-[18px]  font-medium xl:mt-[25px] mt-[15px] font-base1 leading-[1.4]
          ...
          >
            ...
            <button
              className="navBtn-next pointer-events-auto bg-white rounded-full shadow  w-[30px] md:w-10 md:h-10 h-[30px]

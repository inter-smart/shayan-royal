...
export default function SimilarcarSection({ productLists = carData }) {
  ...
  return (
    <section
      className="relative bg-[#F5F9FF] z-0 py-[40px] 2xl:py-[60px] 3xl:py-[105px_130px] after:absolute after:content-[''] overflow-hidden
      ...
      <div className="container">
        ...
        <div className="relative z-1">
          ...
          <div className="flex items-center justify-center absolute top-0 bottom-0 w-full">
            <button
              className="btn-prev absolute left-[-25px] lg:left-[-55px] lg:top-1/2 lg:-translate-y-1/2 z-10
            ...
            <button
              className="btn-next absolute right-[-25px] lg:right-[-55px] lg:top-1/2 lg:-translate-y-1/2 z-10 
                        lg:bg-gradient-to-r from-[#E4E4E4] to-[#FFFFFF] 

...
const menuLinkClass =
  "3xl:text-[18px] 2xl:text-[16px] xl:text-[14px] text-[12px] font-medium uppercase text-black flex items-center justify-center 3xl:px-[25px] 2xl:px-[20px] px-[15px] hover:!text-[#BE1E2D] hover:bg-transparent";
                  ...
                  <NavigationMenuItem key={item.label}>
                    <Link href={item.href} passHref>
                      <NavigationMenuLink asChild>
                        <span
                          className={`${menuLinkClass} ${item.label === "Contact Us" ? "text-white bg-[#2E4C99] h-[40px] !rounded-[50px] hover:!bg-[#BE1E2D] hover:!text-white" : ""
                            }`}
                        >{item.label}</span>
                      </NavigationMenuLink>
                    </Link>
